...
Install-ChocolateyPackage -PackageName 'rabbitmq' -FileType 'exe' -SilentArgs '/S' -Url 'https://github.com/rabbitmq/rabbitmq-server/releases/download/v3.13.99/rabbitmq-server-3.13.99.exe' -ChecksumType sha256 -Checksum 'A3B1B54D4105BBA33CCEFC8EAD7CA10C0087148F1ED29B7FF9A39476501354FF'
